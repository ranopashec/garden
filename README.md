...
Доступ к приватным статьям настраивается через файл `src/site/notes/accepted.md`:
- Добавьте username пользователей Telegram (по одному на строку, без символа @)
...
1. Добавьте переменную окружения в настройках проекта Vercel:
